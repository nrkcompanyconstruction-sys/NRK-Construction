  ...
  const services = [
    {
      ...
      description: 'Complete civil construction works for substations from 33 kV to 765 kV, built for reliability, clear coordination, and long operating life.',
      specs: ['33 kV - 765 kV', 'AIS / GIS / GSS', 'Power-grid civil works'],
    },
    {
      icon: Layers3,
